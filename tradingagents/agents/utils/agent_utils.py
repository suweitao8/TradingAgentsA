...
"""
    ...
    def get_stock_fundamentals_unified(
        ticker: Annotated[str, "股票代码（支持A股）"],
...
"""
    ...
    def get_stock_market_data_unified(
        ...
        """
        统一的股票市场数据工具
        自动识别股票类型（A股）并调用相应的数据源获取价格和技术指标数据
